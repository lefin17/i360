...
--
-- Table structure for table `i360_toDo`
--

DROP TABLE IF EXISTS `i360_toDo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `i360_toDo` (
  `i360_toDo_id` int(6) NOT NULL AUTO_INCREMENT,
  `i360_command_letter` varchar(3) NOT NULL,
  `i360_toDo_started_on` datetime(6) NOT NULL,
  `i360_toDo_finished_at` datetime(6) NOT NULL,
  `i360_command_param` varchar(155) NOT NULL COMMENT 'то что отправлено в параметрах команды',
  `i360_command_result` varchar(155) NOT NULL COMMENT 'то, что сделано',
  `i360_id` int(11) NOT NULL,
  `i360_toDo_error` int(3) NOT NULL COMMENT 'номер ошибки если есть',
  PRIMARY KEY (`i360_toDo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='лист того, что нужно сделать программе phython';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `i360_toDo`
--

LOCK TABLES `i360_toDo` WRITE;
/*!40000 ALTER TABLE `i360_toDo` DISABLE KEYS */;
/*!40000 ALTER TABLE `i360_toDo` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-12-05  5:08:42
